        ...
        <div class="ef-profile__body">
            ...
            <div class="ef-profile__avatar-card" data-reveal>
                ...
                <div>
                    ...
                    <span class="ef-profile__av-role">Kurir</span>
                </div>
            </div>
                    ...
                    <div class="ef-profile__card-body">
                        ...
                        <div class="ef-profile__row">
                            <div class="ef-profile__group">
                                ...
                                @error('name')
                                    <span class="ef-profile__error">{{ $message }}</span>
                                @enderror
                            </div>
                ...
                <div class="ef-profile__card" data-reveal style="margin-top:12px">
                    ...
                    <div class="ef-profile__card-body">
                        ...
                        <div class="ef-profile__row">
                            ...
                            <div class="ef-profile__group">
                                <label class="ef-profile__label" for="password_confirmation">Konfirmasi
                                    Password</label>
                                <div class="ef-profile__input-wrap">
        ...
        (function() {
            ...
            window.efPwToggle = function(id, btn) {
                ...
                btn.innerHTML = show ?
                    ...
                    `<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12S5 5 12 5s11 7 11 7-4 7-11 7S1 12 1 12z"/><circle cx="12" cy="12" r="3"/></svg>`;
            };
        })();
    </script>
