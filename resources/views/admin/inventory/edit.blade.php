    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('admin.inventory.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" class="w-full border px-4 py-2 rounded" value="{{ $product->name }}"
                    required>
            </div>

            {{-- <div class="mb-4">
                <label class="block font-semibold mb-2">Kategori</label>
                <input type="text" name="category" class="w-full border px-4 py-2 rounded" value="{{ $product->category }}"
                    required>
            </div> --}}
            ...
            <div class="mb-4">
                ...
                <input type="number" name="stock" class="w-full border px-4 py-2 rounded" value="{{ $product->stock }}"
                    required>
            </div>
