...
<div class="bg-white shadow-md rounded-lg p-6">
    <form action="{{ route('admin.couriers.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" required class="w-full border-gray-300 rounded-lg" placeholder="Masukkan nama kurir">
        </div>

        {{-- <div class="mb-4">
            <label class="block text-gray-700 mb-1">Username</label>
            <input type="text" name="username" required class="w-full border-gray-300 rounded-lg" placeholder="Masukkan username unik (tanpa spasi)">
        </div> --}}
        ...
        {{-- <div class="mb-4">
            ...
            <input type="email" name="email" required class="w-full border-gray-300 rounded-lg" placeholder="kurir@email.com">
        </div> --}}
        ...
        <div class="mb-6">
            ...
            <input type="password" name="password" required class="w-full border-gray-300 rounded-lg" placeholder="Minimal 8 karakter">
        </div>
