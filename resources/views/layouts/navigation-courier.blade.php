<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 sticky top-0 z-[9999]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-4">
                ...
                <x-dropdown class="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:text-gray-900 transition">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('courier.profile')">
                            {{ __('Profile') }}
                        </x-dropdown-link>
    ...
    <di v :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('courier.home')" :active="request()->routeIs('courier.home*')">
                {{ __('Home') }}
