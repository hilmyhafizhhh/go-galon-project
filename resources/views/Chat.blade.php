{{-- <x-app-layout>
    <div class="p-6">
        <h1 class="text-2xl font-bold text-gogalon-primary p-4">Chat Custom Orders</h1>
        <div class="w-full justify-start items-center pt-8 text-gray-600 bg-gray-300/50 rounded-sm p-4">
            <h3><strong>Depot Efata:</strong><b>Hallo mau pesangalon custom?</b><br>Kami siap bantu merek lain selain
                Aqua/Le Minerale
                atau order besar(+5) </h3>
        </div>
